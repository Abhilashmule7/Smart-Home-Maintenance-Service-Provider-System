...
{
  $sql = "SELECT * FROM `logindetails` where email='".mysqli_real_escape_string($conn,$_POST['uname'])."' and password='".mysqli_real_escape_string($conn,$_POST['psw'])."'";
                            ...
                            <div class="col-md-10">
                                <form class="form-wrap mt-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="submit" class="btn-form"><span class="icon-magnifier search-icon"></span>SEARCH<i class="pe-7s-angle-right"></i></button><div class="slider-link">
